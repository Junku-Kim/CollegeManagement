...
Professor professor;
	...
	@Test
	void OptionalPerson을_OptionalStudent로_변경() {
		...
		Optional<Student> studentOptional1 = StudentUtils.filterStudentOptional(personOptional1);
		Optional<Student> studentOptional2 = StudentUtils.filterStudentOptional(personOptional2);
		Optional<Student> studentOptional3 = StudentUtils.filterStudentOptional(personOptional3);
		
		assertThat(studentOptional1).isEmpty();
		assertThat(studentOptional2.get().getLoginId()).isEqualTo(this.student.getLoginId());
		assertThat(studentOptional3).isEmpty();
	}
	
	@Test
	void ListPerson을_ListStudent로_변경() {
		List<Student> students = StudentUtils.filterStudents(this.persons);
		
		assertThat(students).extracting(Student::getDtype).containsOnly("STUDENT");
	}
}
